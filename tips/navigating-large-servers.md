...
- When you want to ask a question
  - Please direct questions to `#server-questions` or `#server-questions-2` and patiently wait for a reply. If it gets buried, you can :bell: react to your question to escalate it.
