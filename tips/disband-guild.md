...
4. Once you have a new leader, put a request using the Guild Representative template in [!badge icon="/images/discord-mark-blue.svg" variant="info" text="#guild-registry"](https://discord.com/channels/512870694883950598/729487863242031288), but add a note that they are the new guild leader.
