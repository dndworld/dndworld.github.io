...
You do not have access to the rest of the server until you import your first character. For that, please visit [Start Here](/dwguide/character-building/start-here/) and follow the steps there. If you are new to D&D, [New to D&D](/dwguide/character-building/new-to-dnd/) has a step-by-step guide to help you through the character creation process.
...
Once you make your character and import it to `#character-sheets`, you will be able to see the rest of the server. Head over to [Start Here](/dwguide/character-building/start-here/) for the guide. If you are new to D&D, follow the step-by-step guide in [New to D&D](/dwguide/character-building/new-to-dnd/)!

==- "How do I make a D&D character?"
The steps are outlined in [Start Here](/dwguide/character-building/start-here/). If you are new to DnD and unfamiliar with the character creation process, [New to D&D](/dwguide/character-building/new-to-dnd/) is for you!
...
What official, homebrew, and UA sources and content we allow can be found in [Character Creation Rules](/dwguide/character-building/cc-rules/).
...
Please make sure to follow [Roleplay Rules](rp-rules.md) for your RPs! You can earn RPXP when you are interacting with other characters. To learn more about this, please checkout "RPXP" sections in [How To Start Playing](/dwguide/start-playing/start-playing/) and [How to Earn XP](/dwguide/start-playing/earn-xp/). The RPXPs and XPs need to be logged in `#⁠xp-tracker`.
...
To learn more about all types of available games on this server, please visit "DM Events" section in [How to Earn XP](/dwguide/start-playing/earn-xp/#3-dm-events/). For instruction on how to join them, visit "Signing up for DM events" section of [How To Start Playing](/dwguide/start-playing/start-playing/#signing-up-for-dm-events/).

==- "How can my character make money?"
We use Lifestyle and Downtime Days (DTD) system. You can find the rules and guides in [Lifestyle and DTD Rules](/dwguide/downtime-and-lifestyle/). All relevant channels can be found under the same category. With this system you can find an odd job for day-to-day earnings, or a part-time work for a more consistent pay. There are many more options! If you still have questions after reading the guide, ask for help in `#dtd-ls-discussion`.
...
- If a beast is not native to Icris, then our rules governing backstories in [Character Creation Rules](/dwguide/character-building/cc-rules/) prevent you from having seen them in your backstory. If you later see them in-game, then you might be able to transform into them at your respective DMs' discretion.
