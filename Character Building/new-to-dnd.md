...
#### Rolling for Gold
If you choose to roll for gold, you MUST make the rolls in `#⁠official-character-rolls`, **NOT** in D&D Beyond. You can then do the equipment shopping after you upload your character. Follow the prices in Snowhaven Market document above, and log the transactions in ⁠`#transaction-log`.
