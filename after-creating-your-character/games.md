...
> ```
> 
> The full explanation of Combat Training DTD can be found in [!badge icon="mark-github" variant="dark" text="Lifestyle rules"](/downtime-and-lifestyle/lifestyle/), and the command description and argument options can be found by running `!help train` in [!badge icon="/images/discord-mark-blue.svg" text="#bot-dump"](https://discordapp.com/channels/512870694883950598/519131071502221313). You can do 1 DTD per day, up to 5 per week.
