...
- [!badge icon="mark-github" variant="dark" text="Our Partner Servers"](/misc/partner-servers/)
...
We use a modified version of Blood Hunter. For full list of sources, please see [!badge icon="mark-github" variant="dark" text="here"](cc-rules/)
!!!
...
As a Level 1 character, what you can achieve now is limited. The [!badge icon="mark-github" variant="dark" text="Backstory Guide"](/charcre-v2/4/) goes into more detail about what topics to avoid if you would like to flesh out your backstory.
!!!
...
> The players on this server can get access to paid material, sponsored by D&D Beyond and patrons of the server. For more info please refer [!badge icon="mark-github" variant="dark" text="here"](ddb/).
...
#### Skills
> Each skill uses one of your abilities as explained [here](https://www.dndbeyond.com/sources/basic-rules/using-ability-scores#UsingEachAbility).
...
> Filling out the Character Details, Physical Characteristics, etc. is optional. Feel free to skip this and simply describe as you go along. You can check out the [!badge icon="mark-github" variant="dark" text="Backstory Guide"](/charcre-v2/4/) for fleshing out your character.

### 3. Species/Race
> Races refer to human, elves, dwarves, etc. Each race can provide some mechanical benefit to your character in game, such as stats, traits, or even spells! For approved/disapproved materials, see [!badge icon="mark-github" variant="dark" text="Character Creation Rules"](cc-rules/). The descriptions on races can be found [here](https://www.dndbeyond.com/races)
> 
...
Below is a list of common D&D lingo that's not otherwise explained in the above document. For more lingo (including server-specific ones), please check out [!badge icon="mark-github" variant="dark" text="here"](/misc/resources/#abbreviationslingo).
